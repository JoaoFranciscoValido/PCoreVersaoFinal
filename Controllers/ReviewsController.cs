...
namespace PCore.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Reviews.Include(r => r.Componente).Include(r => r.Utilizador);
        ...
        public async Task<IActionResult> Create([Bind("IdReview,Comentario,Pontuacao,Data,UtilizadoresFK,ComponentesFK")] Reviews reviews)
        {
            ...
            ViewData["ComponentesFK"] = new SelectList(_context.Componentes, "IdComponentes", "Foto", reviews.ComponentesFK);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdReview,Comentario,Pontuacao,Data,UtilizadoresFK,ComponentesFK,Visibilidade")] Reviews reviews)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Details), "Componentes", new { id = reviews.ComponentesFK });
        }
